...
function surveyToolMenu(): string {
  return [
    ...
    '  getSectionOf({evidenceId}) — which engineering section something belongs to, and every cluster it is drawn across',
    '  getRegionOf({evidenceId}) — which visual cluster something sits in',
