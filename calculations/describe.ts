...
//
// Moved out of `cad/bbs/` because the calculation layer writes this string on
// every row it builds, and a schedule rebuilt from its own inputs must be able
// to produce it without the drawing reader present.
//
// `cad/bbs/describe.ts` re-exports it, so callers are unchanged.
// ============================================================
// ============================================================
// What to call a bar
//
...
// ============================================================
import type { BbsBar, BbsMember } from '../src/cad/bbs/types';
